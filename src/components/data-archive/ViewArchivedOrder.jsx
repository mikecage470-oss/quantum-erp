...
export default function ViewArchivedOrder({ order, isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="archived-order-detail-title">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            <h2 id="archived-order-detail-title" className="text-2xl font-bold text-gray-900">Archived Order Details</h2>
            ...
            <TabsContent value="general" className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <InfoRow label="Archive Date" value={formatDate(order.archiveDate)} />
                  <InfoRow label="Archived At" value={formatDate(order.archivedAt)} />
